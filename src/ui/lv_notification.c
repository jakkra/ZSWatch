...
void lv_notification_show(char *title, char *body, notification_icon_t icon, on_close_not_cb_t close_cb)
{
    ...
    lv_style_set_bg_color(&style_indic_not_bg, lv_palette_main(LV_PALETTE_BLUE_GREY));
    ...
    lv_obj_align_to(img_icon, mbox, LV_ALIGN_TOP_RIGHT, 0, -40);
}
