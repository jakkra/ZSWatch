...
static void refresh_ui(void)
{
    ...
    zsw_watchface_dropdown_ui_set_battery_info(last_batt_evt.percent, last_batt_evt.is_charging);
...
static void zbus_battery_sample_data_callback(const struct zbus_channel *chan)
{
    ...
    if (running && !is_suspended) {
        ...
        zsw_watchface_dropdown_ui_set_battery_info(last_batt_evt.percent, event->is_charging);
    }
}
