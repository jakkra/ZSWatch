...
static void play_event_click_cb(lv_event_t *e)
{
    ...
    if (code == LV_EVENT_FOCUSED && obj != play_pause_button) {
        ...
        if (obj == play_pause_button) {
            ...
            lv_image_decoder_get_info(ZSW_LV_IMG_USE(play), &header);
...
static void create_buttons(lv_obj_t *parent)
{
    ...
    lv_image_decoder_get_info(ZSW_LV_IMG_USE(pause_icon), &header);
    ...
    lv_image_decoder_get_info(ZSW_LV_IMG_USE(next), &header);
    ...
    lv_image_decoder_get_info(ZSW_LV_IMG_USE(previous), &header);
