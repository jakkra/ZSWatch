...
LOG_MODULE_REGISTER(zswatch_board_init);
...
BUILD_ASSERT(CONFIG_ZSWATCH_INIT_PRIORITY > CONFIG_REGULATOR_FIXED_INIT_PRIORITY,
	"CONFIG_ZSWATCH_INIT_PRIORITY must be higher than CONFIG_REGULATOR_FIXED_INIT_PRIORITY");
#endif /* CONFIG_REGULATOR_FIXED */

#if defined(CONFIG_SENSOR)
BUILD_ASSERT(CONFIG_ZSWATCH_INIT_PRIORITY < CONFIG_SENSOR_INIT_PRIORITY,
	"CONFIG_ZSWATCH_INIT_PRIORITY must be less than CONFIG_SENSOR_INIT_PRIORITY");
#endif
...
SYS_INIT(setup, POST_KERNEL, CONFIG_ZSWATCH_INIT_PRIORITY);
