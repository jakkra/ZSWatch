...
var ASM_CONSTS = {
 ...
 236558: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 236641: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 236710: () => { return window.innerWidth; },  
 236740: () => { return window.innerHeight; }
};
